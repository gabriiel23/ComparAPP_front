                ...
                <div className={`items-center justify-between ${isMenuOpen ? 'block' : 'hidden'} w-full sm:flex sm:w-auto sm:order-1`} id="navbar-search">
                    ...
                    <ul className="text-lg flex flex-col p-4 sm:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 sm:space-x-8 rtl:space-x-reverse sm:flex-row sm:mt-0 sm:border-0 sm:bg-white dark:bg-black dark:border-gray-700">
                        ...
                        <li className="sm:hidden mt-4">
                            <Link to="/login" className="text-white inline-flex items-center justify-center px-4 py-2 border text-sm font-medium rounded-lg bg-black hover:bg-gray-950 border-[#fcf149] focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#f5f3d5]">Iniciar Sesión</Link>
                        </li>
                        <li className="sm:hidden mt-4">
                            <Link to="/register" className="text-white inline-flex items-center justify-center px-4 py-2 border text-sm font-medium rounded-lg bg-black hover:bg-gray-950 border-[#fcf149] focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#dcd23b]">Registrarse</Link>
                        </li>
                    </ul>
                </div>
            </div>

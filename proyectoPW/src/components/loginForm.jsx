                    ...
                    <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                        <div>
                            ...
                            <p className="text-lg max-w-xl mt-3 text-gray-300">
                                Dale un programa a alguien y lo frustraras por un día; <br />
                                enseñale a programar y lo frustrarás toda la vida.
                            </p>

                            <h2 className="text-2xl mt-8 font-bold text-white sm:text-4xl">;</h2>
                            <p className="text-lg max-w-xl mt-3 text-gray-300">
                                Sería genial que el error típico de programación <br />
                                sea tan solo la falta de un simple punto y coma.<br />
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex-1">
                        <div className="text-center">
                            <div className="flex justify-center mx-auto">
                                <img className="w-auto h-7 sm:h-8 rounded-lg" src="https://i.pinimg.com/564x/f8/c9/00/f8c90079ddaeb7b1ec1ceddeda867471.jpg" alt="" />
                            </div>
                        ...
                        <div className="mt-8">
                            <form>
                                ...
                                <div className="mt-6">
                                    ...
                                    <input type="password" name="password" id="password" placeholder="contraseña" className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                </div>

                                <div className="mt-6">
                                    <button className="w-full px-4 py-2 tracking-wide text-black transition-colors duration-300 transform bg-[#fcf149] rounded-lg hover:bg-[#cbc246] focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                        Iniciar Sesión
                                    </button>
                                </div>
                            </form>

                            <p class="mt-6 text-base text-center text-black ">

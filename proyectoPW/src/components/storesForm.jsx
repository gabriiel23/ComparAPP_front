    ...
    return (
        <div className='content-center sm:px-48 sm:py-12'>
            ...
            <div className='flex items-center justify-center py-8'>
                <button
                    className="overflow-hidden relative w-72 p-2 h-20 bg-black text-[#faef57] border-none rounded-lg text-4xl font-bold cursor-pointer z-10 group"
                >
                    TIENDAS
                    <span
            ...
            <div className='flex flex-wrap items-center justify-center gap-8 py-12'>
                {opciones.map((item, index) => (
                    <Link to={item.link} className="block" key={index}>

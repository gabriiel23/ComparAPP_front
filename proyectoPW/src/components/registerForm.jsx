...
const RegisterForm = () => {
    ...
    return (
        <div className="font-[sans-serif] bg-white md:h-screen sm:mb-10 mb-0">

            <div className="grid md:grid-cols-2 items-center gap-8 h-full">

                <div className="hidden bg-cover lg:block lg:w-2/3">
                    <img src="/register.png" className="object-contain block mx-32" alt="login-image" />
                </div>

                <div className="flex items-center md:p-8 p-6 bg-black h-full lg:w-11/12 lg:ml-auto">

                    <form onSubmit={handleSubmit(onSubmitRegister)} className="max-w-lg w-full mx-auto">
                        ...
                        <div className="mt-10">
                            <button type="submit" className="w-max shadow-xl py-3 px-6 text-sm text-gray-800 font-semibold rounded-md bg-[#fcf149] hover:bg-yellow-500 focus:outline-none">
                                Registrarse
                            </button>
